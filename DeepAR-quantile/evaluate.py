    ...
    with torch.no_grad():
      ...
      for i, (test_batch, id_batch, v, labels) in enumerate(tqdm(test_loader)):
          ...
          if sample:
              ...
              raw_metrics = utils.update_metrics(raw_metrics, input_y_pred, input_sigma, sample_mu, labels, params.test_predict_start, samples, relative = params.relative_metrics) # uncomment
          else:
              sample_mu, sample_sigma, sample_y_pred = model.test(test_batch, v_batch, id_batch, hidden, cell)
